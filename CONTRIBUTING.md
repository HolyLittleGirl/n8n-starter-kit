...
We make opinionated choices about the core stack (n8n + Qdrant + PostgreSQL)
to reduce decision paralysis, while providing clear paths for users to extend
and customize as they learn. Users can connect to external LLM services
(Ollama, OpenAI, etc.) as needed.
